...
export default function ToDoList() {
  ...
  useEffect(() => {}, []);
  //fct appelee a chaque rendu (chaque load de la page) sappele une fois au montage du composant(quand le composant est complet), car [] est vide, si on met des variables
