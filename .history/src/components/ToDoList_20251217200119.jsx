...
export default function ToDoList() {
  ...
  // CORRECTION: Vérifier que todos est un tableau avant de filtrer
  ...
  // CORRECTION: S'assurer que todos est un tableau
  const safeTodos = Array.isArray(todos) ? todos : [];

  let todosToBeDisplayed = safeTodos;
  if (displayedTodosType === "completed") {
    todosToBeDisplayed = completedTodos;
  } else if (displayedTodosType === "non-completed") {
    todosToBeDisplayed = notCompletedTodos;
  } else {
    todosToBeDisplayed = safeTodos;
  }
